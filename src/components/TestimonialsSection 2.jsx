  ...
  const reviews = [
    {
      ...
      rating: 5,
      quote: 'Best gym in Vizianagaram! The trainers are certified and very supportive. I have seen amazing results in just 3 months.',
      pullQuote: 'Amazing results in 3 months.',
      tag: 'STRENGTH',
      stat: '3 months',
      statLabel: 'To transformation',
      avatar: 'RK',
      color: '#F59E0B',
    },
    {
      ...
      rating: 5,
      quote: 'Passionate trainers with state-of-the-art equipment. The female trainers are empowering and make you feel confident.',
      pullQuote: 'Empowering. Confident. Changed.',
      tag: 'WELLNESS',
      stat: '+12kg',
    ...
    },
    {
      ...
      pullQuote: 'Everything I needed to transform.',
      tag: 'PERFORMANCE',
      stat: '–18kg',
    ...
    },
    {
      ...
      pullQuote: 'The community keeps me going.',
      tag: 'COMMUNITY',
      stat: '200+',
      statLabel: 'Strong members',
      avatar: 'SG',
      color: '#8B5CF6',
    },
  ];
      ...
      <div style={{ padding: '80px 40px', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'right' }}>
            <div style={{ fontSize: '64px', fontWeight: 900, color: '#fff', lineHeight: 1 }}>4.8</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ color: '#555', fontSize: '11px', fontWeight: 700, letterSpacing: '0.12em', marginTop: '6px' }}>
                  {active.statLabel.toUpperCase()}
                </div>
              </div>
              <div style={{ color: '#222', fontSize: '11px', fontWeight: 600, letterSpacing: '0.1em' }}>
        ...
        <div style={{
          ...
          {reviews.map((r, i) => (
            <button
              ...
              style={{
                background: i === activeIndex ? '#1A1A1A' : '#0D0D0D',
                border: 'none',
                padding: '28px 28px',
                cursor: 'pointer',
                textAlign: 'left',
                borderTop: `3px solid ${i === activeIndex ? r.color : 'transparent'}`,
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
                <div style={{
                  ...
                  height: '32px',
                  borderRadius: '50%',
                  background: i === activeIndex ? r.color : '#222',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  fontSize: '10px',
                  fontWeight: 800,
                  color: i === activeIndex ? '#000' : '#555',
                  transition: 'all 0.4s ease',
                  flexShrink: 0,
                }}>{r.avatar}</div>
                <div>
                  ...
                  <div style={{ color: '#333', fontSize: '10px', fontWeight: 600, letterSpacing: '0.08em' }}>{r.tag}</div>
                </div>
              </div>
            </button>
          ))}
