            ...
            <div>
              {formSubmitted ? (
                ...
                >
                  ...
                  <h3 style={{
                    fontFamily: "'Bebas Neue', sans-serif",
                    fontSize: '48px', color: '#fff', margin: 0, lineHeight: 1,
                  }}>MESSAGE SENT</h3>
                  <p style={{ color: 'rgba(255,255,255,0.35)', fontSize: '13px', lineHeight: 1.7, margin: 0, maxWidth: '320px' }}>
                  ...
                  <div style={{ marginTop: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <span style={{ fontSize: '9px', fontWeight: 700, color: '#10B981', letterSpacing: '0.18em', textTransform: 'uppercase' }}>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  ...
                  <div style={{ marginBottom: '32px' }}>
                    <label className="cf-checkbox-wrap" onClick={() => setAgreed(!agreed)}>
                      ...
                      <span style={{ fontSize: '11px', color: 'rgba(255,255,255,0.3)', fontWeight: 400, letterSpacing: '0.03em' }}>
                  ...
                  {/* Helper text */}
                  <p style={{ marginTop: '14px', fontSize: '10px', color: 'rgba(255,255,255,0.18)', letterSpacing: '0.04em', textAlign: 'center' }}>
            ...
            <div>
              ...
              <div className="ci-image-wrap" style={{ marginBottom: '40px' }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '16px', color: '#F59E0B', letterSpacing: '0.06em', lineHeight: 1 }}>
                    INTENSE FITNESS STUDIO
                  </div>
                  <div style={{ fontSize: '8px', fontWeight: 600, color: 'rgba(255,255,255,0.3)', letterSpacing: '0.2em', marginTop: '3px' }}>
                ...
                {contactItems.map((item, i) => (
                  <div key={item.label} className="ci-card" style={{ borderBottom: i === contactItems.length - 1 ? '1px solid rgba(255,255,255,0.06)' : 'none' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                      <div style={{ flex: 1 }}>
                        ...
                        {item.href ? (
                          <a
                            href={item.href}
                            className="ci-value"
                            style={{ color: 'rgba(255,255,255,0.55)', fontSize: '13px', fontWeight: 400, lineHeight: 1.5, display: 'block', textDecoration: 'none' }}
                          >
                            {item.value}
                          </a>
                        ) : (
                          <p
                            className="ci-value"
                            style={{ color: 'rgba(255,255,255,0.55)', fontSize: '13px', fontWeight: 400, lineHeight: 1.6, margin: 0, whiteSpace: 'pre-line' }}
                          >
                            {item.value}
                          </p>
                        )}
                      ...
                      <span
                        className="ci-icon"
                        style={{ fontSize: '14px', color: 'rgba(255,255,255,0.15)', marginLeft: '16px', marginTop: '20px' }}
                      >
                        {item.icon}
                      </span>
                    </div>
